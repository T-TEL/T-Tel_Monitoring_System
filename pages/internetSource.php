    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Internet Source</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                    <?php
					foreach($array_internet as $isp) {
						$array_key = array_search($isp,$array_internet)+1;
						if(intval($array_key%4)== 0){
							print('<div class="row">');
						}
						
						 $ispCnt = 0;
						foreach($inst_id as $schoolID) {
							$getSQLdata =  mysql_query("SELECT * FROM `log_internet_source` where INST_ID = '$schoolID' AND REC_DATE = ( Select MAX(REC_DATE) FROM log_internet_source where INST_ID = '$schoolID' )  AND STATUS ='".$isp."'") or die(mysql_error());
						...
						if($isp=="ISP NOT AVAILABLE"){
							echo ' <div class="col-lg-3 col-md-6">
							<div class="panel panel-red">
							  <div class="panel-heading">
								<div class="row">
								  <div class="col-xs-3"> <i class="fa fa-wifi fa-5x"></i> </div>
								  <div class="col-xs-9 text-right">
									<div class="huge">
									'.$ispCnt.'
									</div>
									<div><br><span style="font-weight: bold">ISP NOT AVAILABLE</span></div>
								  </div>
								</div>
							  </div>
							 </div>
							  ...
							  <div class="panel-heading">
								<div class="row">
								  ...
								  <div class="col-xs-9 text-right">
									...
									<div><br><span style="font-weight: bold">'.$isp.'</span></div>
								  </div>
								</div>
							  </div>
							  </div>
                      ...
                      <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                          <div class="dataTable_wrapper">
							...
							$getSQLdata =  mysql_query("SELECT * FROM `log_internet_source` order by REC_DATE DESC") or die(mysql_error());
							while($rowData = mysql_fetch_array($getSQLdata)){
